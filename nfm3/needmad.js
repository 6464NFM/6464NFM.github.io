                ...
                if (frgm >= m) {
                    if (ugrip < cd.grip[cn]) {
                        ...
                        if ((dcnt[c] > (40 * ugrip / cd.grip[cn])) || (capsized[c])) {
                            ...
                            if (Math.random() > 0.65) {
                                dustup(tskd, c, i, kx[i], ky[i], kz[i], scx[c][i], scz[c][i], (mag * cd.simag[cn]), tilt[c], ((capsized[c]) && (carIsGrounded[c])));
                            ...
                            if (tskd == 1) {
                                if (Math.random() > 0.8) {
                                    dustup(tskd, c, i, kx[i], ky[i], kz[i], scx[c][i], scz[c][i], (1.1 * cd.simag[cn]), tilt[c], ((capsized[c]) && (carIsGrounded[c])));
                                }
                            }
                            if (tskd == 2) {
                                if (Math.random() > 0.6) {
                                    dustup(tskd, c, i, kx[i], ky[i], kz[i], scx[c][i], scz[c][i], (1.15 * cd.simag[cn]), tilt[c], ((capsized[c]) && (carIsGrounded[c])));
                                }
                            }
                        }
                    } else {
            ...
            if (ky[i] < -0.05) {
                ...
                if (!wastouch) {
                    if (scy[c][i] != -0.7) {
                        ...
                        dustup(tskd, c, i, kx[i], ky[i], kz[i], scx[c][i], scz[c][i], (mag * cd.simag[cn]), 0, ((capsized[c]) && (carIsGrounded[c])));
                    }
                }
                ky[i] = 0;
                                            ...
                                            if ((ky[k] < (coly - 0.05)) && (ky[k] > (coly - 20))) {
                                                ...
                                                if (!wastouch) {
                                                    if (scy[c][k] != -0.7) {
                                                        ...
                                                        dustup(tskd, c, k, kx[k], ky[k], kz[k], scx[c][k], scz[c][k], (mag * cd.simag[cn]), 0, ((capsized[c]) && (carIsGrounded[c])));
                                                    }
                                                }
                                                ky[k] = coly;
                                                if (capsized[c]) {
